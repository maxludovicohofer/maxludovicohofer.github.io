...
- I developed the system for Python and Typescript. It is composed of a matcher engine and candidate evaluators. It's fully declarative, able to read parameters from files and to override any optimal or candidate parameter dynamically in time.
