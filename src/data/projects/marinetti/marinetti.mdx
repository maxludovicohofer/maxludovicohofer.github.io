...
Attributes are customizable, and can be both objective and subjective. This means the recommender system can follow artistic or opinionated parameters. It can be used generically where one desires more art-driven reccommendations, e.g. AI. This differs from content-based filtering systems, where reccommendations are user driven.
...
- The system is easily customizable with standardized parameter evaluation and a dedicated TouchDesigner integration.
