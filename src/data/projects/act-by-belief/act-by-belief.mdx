...
Current game AI is often a checklist that settles on specific behavior. While maybe easy to debug, it does not follow a fluid thought process, easily resulting in robotic behavior. Reusing these imperative decision trees can be daunting, as they couple AI with gameplay. With this system, I aim to address these issues through a [Maslow hierarchy](https://en.wikipedia.org/wiki/Maslow%27s_hierarchy_of_needs)-inspired declarative infrastructure that is performant, easy to use and debug.
