...
Steelsilk Championship is a couch co-op rougelite hero shoot 'em up, where victory is achieved by resisting three arenas. The game was outlined by my game development school, then passed onto my classmates and me to develop further. We imagined a target audience interested in small catchy games, where people could team up with their friends or achieve a quick solo flow state. Our goal was to create a genre game that favored positive interactions among players, theorycrafting and replayability. At the same time, we sacrificed design focus and faster development times in favor of deepening our skillsets of choice.

{/* First point: character, second point: world, third point: development solutions. Split if too long, in max 4 points */}

* The game was originally thought out for 4 players, but we scaled the number of heroes down to 2, while allowing a flexible 1 to 4 players. I designed the two heroes to have opposite playstyles that relied on each other to truly shine. For example, one spider specializes in areas of effect, but only the other spider is fast enough to herd enemies. To win at Steelsilk, character interplay was designed to be a necessity.
