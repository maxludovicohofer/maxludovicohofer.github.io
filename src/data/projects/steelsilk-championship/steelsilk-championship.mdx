...
roles:
  - role: game designer
    ...
    achievements:
      ...
      - brought the game's vision to life with all departments by managing deadlines and teams

  - role: level designer
    tasks:
      - designing three arenas that allowed characters to move freely
    achievements:
      - designed free-roam maps that prioritized visibility in accordance with the camera and gameplay elements, and allowed space for enemies to spawn
  ...
  - role: camera programmer
    ...
    achievements:
      - programmed camera to continuously follow characters in long-take style, fixing awkward map locations and dynamic zoom levels
  ...
  - role: UI/UX lead
    ...
    achievements:
      - led UI designers to an accessible graphic style that emphasizes the futuristic setting of the game
      - the UI supports keyboard and mouse, and multiple controllers at the same time

  - role: technical animation lead
    tasks:
      - supporting the animation team's efforts for procedural critters and flying characters
    achievements:
      - developed a deterministic procedural animation system to simplify development of insect legs
  ...
  - role: gameplay programmer
    ...
    achievements:
      - programmed skills with responsive lazy loading and consistency as priorities
      - programmed multiple procedural systems and a custom attribute system that favored ease of development

  - role: operations engineer
    tasks:
      - managing collaboration tools and shared game data
    achievements:
      - managed SVN server and authorizations with a medium-sized team without significant bottlenecks at no cost
      - significantly sped up debugging by promoting a DevOps culture to empower devs to cook and release autonomously
