...
- role: game designer
  tasks:
  - planning, designing and developing a game prototype
  achievements:
...
- role: team lead
  ...
  - TODO
  achievements:
  - directed a cross-functional team of 4 with a stressful deadline

- role: gameplay programmer
  tasks:
  - TODO
  achievements:
  - programmed a tile-based procedural map generation algorithm

- role: UI designer
  tasks:
  - TODO
  achievements:
  - designed an intuitive UI that led players to their goal

- role: technical artist
  tasks:
  - TODO
  achievements:
  - organized a pipeline with artists to work with procedural content
