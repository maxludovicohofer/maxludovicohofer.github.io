...
roles:
  ...
  - role: level designer
    tasks:
      - designing an instanced open world for multiplayer that tends to a state of symmetry
    achievements:
      - designed a section-based map system, able to reuse assets for multiple instances
      - mapped platforming elements to enable symmetry or asymmetry on demand
  ...
  - role: operations tools programmer
    tasks:
...
In a black-metal inspired industrial earth, people believe that detachment from reality brings their soul closer to an iris-like god. Every 111 years believers corrupt their bodies, claim three powerful soul-bound artifacts, and face a bloody ritual for a fourth one.
