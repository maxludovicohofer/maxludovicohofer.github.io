...
* To make countering the AI as intuitive as possible, I programmed behavior that mimics human perception. This turned out to be the biggest development challenge, as it required a lot of back and forth to check if numbers in code corresponded to my intuition. Therefore, I spent some effort to make the code easily tweakable, and considerably sped up iterations.